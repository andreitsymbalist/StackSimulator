...
@Component
public class SolveExpressionAction implements Action {

    private final StackService<String> stackService;
    private final MathService mathService;

    @Autowired
    public SolveExpressionAction(StackService<String> stackService, MathService mathService) {
    ...
    public void execute(int index) {
        ...
        System.out.println("\n" + stack.elementAt(index) + " = " +
                mathService.solveExpressions(stack.elementAt(index)) + "\n");
    }
}
